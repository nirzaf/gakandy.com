        ...
        <div className="flex justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className="text-gray-700 hover:text-[#033A5B] px-3 py-2 font-medium inline-flex items-center gap-2">
              <Home size={18} className="text-[#22B0EB] group-hover:text-[#033A5B] transition-colors" aria-hidden="true" />
              <span>Home</span>
            </Link>
            <Link to="/about" className="text-gray-700 hover:text-[#033A5B] px-3 py-2 font-medium inline-flex items-center gap-2">
              <Users size={18} className="text-[#22B0EB] group-hover:text-[#033A5B] transition-colors" aria-hidden="true" />
              <span>About Us</span>
            </Link>
            <Link to="/services" className="text-gray-700 hover:text-[#033A5B] px-3 py-2 font-medium inline-flex items-center gap-2">
              <Briefcase size={18} className="text-[#22B0EB] group-hover:text-[#033A5B] transition-colors" aria-hidden="true" />
              <span>Services</span>
            </Link>
            <Link to="/contact" className="text-gray-700 hover:text-[#033A5B] px-3 py-2 font-medium inline-flex items-center gap-2">
              <PhoneCall size={18} className="text-[#22B0EB] group-hover:text-[#033A5B] transition-colors" aria-hidden="true" />
              <span>Contact</span>
            </Link>
          </div>
